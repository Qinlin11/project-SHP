                    ...
                    <div class="content">
                        <form >
                            <div class="input-text clearFix">
                                ...
                                <div class="error-msg" style="color: red">{{ errors.first("phone") }}</div>
                            </div>
                            <div class="input-text clearFix">
                                <span class="pwd"></span>
                                ...
                                <div class="error-msg" style="color: red">{{ errors.first("password") }}</div>
                            </div>
    ...
    methods: {
        ...
        async userLogin() {
            try {
                ...
                //登录的路由组件：看路由当中是否包含query参数，有的话：跳到query参数指定的路由，没：跳到home主页
